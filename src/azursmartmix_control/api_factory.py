...
from azursmartmix_control.api_mountpoints import (
    MountpointsSaveRequest,
    get_mountpoints_payload,
    save_mountpoints_payload,
)
...
""".strip()
    ...
    def config_mountpoints() -> Dict[str, Any]:
        try:
            return get_mountpoints_payload(settings)
        except Exception as e:
            return {
                "ok": False,
                "source": "config_yaml",
    ...
    def config_mountpoints_save(req: MountpointsSaveRequest) -> Dict[str, Any]:
        try:
            return save_mountpoints_payload(settings, req.outputs)
        except Exception as e:
            return {
                "ok": False,
                "source": "config_yaml",
